...
const PlayVideo = () => {
    ...
    const fetchVideoData = async () =>{
        ...
        try{
            ...
            console.error("Error fetching the videoDetail data", error)
        }
    }
    ...
    return (
        <div className='play-video'>
            ...
            <div className="play-video-info">
                <p>{apiData?value_converter(apiData.statistics.viewCount):"0k"} Views &bull;  {apiData?moment(apiData.snippet.publishedAt).fromNow():" "} </p>
                <div>
                    <span><img src={like} alt="" />{apiData?value_converter(apiData.statistics.likeCount):"0k"}</span>
            ...
            <div className="vid-description">
                <p>{apiData?apiData.snippet.description.slice(0,250):"Descritopn Here"}</p>
                <hr />
